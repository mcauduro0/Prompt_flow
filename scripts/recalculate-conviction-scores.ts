 ...
 * 
 * Usage: cd /opt/arc && node scripts/recalculate-conviction-scores.js
 */

import 'dotenv/config';
import { icMemosRepository, ideasRepository } from '../packages/database/dist/index.js';
import { calculateConvictionScoreV2 } from '../packages/worker/dist/scoring/conviction-score-v2.js';
